...
export function SavedJobs() {
  ...
  return <Layout>
      ...
      {isLoading ? <div className="flex justify-center py-12">
        ...
        </div> : savedJobsList.length > 0 ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <h3 className="text-xl font-medium text-gray-300">No saved jobs</h3>
