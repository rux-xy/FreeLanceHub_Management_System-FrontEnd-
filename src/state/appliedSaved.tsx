...
export function AppliedSavedProvider({
  ...
  useEffect(() => {
    ...
    setAppliedJobs(readStore<Record<string, string[]>>(STORAGE_KEYS.APPLIED_JOBS, {})[user.id] || []);
    setSavedJobs(readStore<Record<string, string[]>>(STORAGE_KEYS.SAVED_JOBS, {})[user.id] || []);
  }, [user]);
