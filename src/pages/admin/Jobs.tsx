...
export function AdminJobs() {
  const { jobs, fetchJobs, toggleFlag, isLoading } = useJobs();
    ...
    <Layout>
      ...
      <div className="bg-[#111827]/50 border border-gray-800 p-4 rounded-xl mb-6">
        <div className="relative">
          ...
          <Input
            placeholder="Search jobs by title or creator..."
            className="pl-10"
            value={search}
      ...
      <Card className="overflow-hidden p-0">
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tr
                key={job.id}
                className={`border-b border-gray-800/50 hover:bg-[#1f2937]/30 transition-colors ${job.flagged ? 'bg-red-900/10' : ''}`}>
